...
/*
*****************************************************
* Homepage Slideshow custom post
*
* CONTENT:
...
*/
	//ACTIONS
		//Registering CP
		add_action( 'init', 'sp_home_slider_cp_init' );
		//CP list table columns
		add_action( 'manage_posts_custom_column', 'sp_home_slider_cp_custom_column' );

	//FILTERS
		//CP list table columns
		add_filter( 'manage_edit-home_slider_columns', 'sp_home_slider_cp_columns' );
...
*/
	...
	*/
	if ( ! function_exists( 'sp_home_slider_cp_init' ) ) {
		function sp_home_slider_cp_init() {
			global $cp_menu_position;

			$labels = array(
				'name'               => __( 'Home slidershow', 'sptheme_admin' ),
				'singular_name'      => __( 'Homepage slider', 'sptheme_admin' ),
			...
			$args = array(
				...
				'menu_position'         => $cp_menu_position['menu_home_slider'],
...
*/
	...
	*/
	if ( ! function_exists( 'sp_home_slider_cp_custom_column' ) ) {
		function sp_home_slider_cp_custom_column( $column ) {
			global $post;
	...
	} // /sp_home_slider_cp_custom_column
